...
/**
 * Adapter dùng để hiển thị danh sách các Giao dịch (Transaction) lên RecyclerView.
 * Kế thừa từ RecyclerView.Adapter
 */
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.ViewHolder> {

    private final Context context;
    private final List<Transaction> transactions; // Danh sách dữ liệu giao dịch
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Nạp layout item_transaction.xml thành View
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String amountValue = fmt.format(Math.abs(t.getAmount()));
